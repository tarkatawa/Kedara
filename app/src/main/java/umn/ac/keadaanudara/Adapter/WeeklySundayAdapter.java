...
public class WeeklySundayAdapter extends RecyclerView.Adapter<WeeklySundayAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public WeeklySundayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull WeeklySundayAdapter.ViewHolder holder, int position) {
