...
public class OneTimeAdapter extends RecyclerView.Adapter<umn.ac.keadaanudara.OneTimeAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public umn.ac.keadaanudara.OneTimeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull umn.ac.keadaanudara.OneTimeAdapter.ViewHolder holder, int position) {
