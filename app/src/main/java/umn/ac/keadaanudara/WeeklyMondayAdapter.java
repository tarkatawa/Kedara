...
public class WeeklyMondayAdapter extends RecyclerView.Adapter<umn.ac.keadaanudara.WeeklyMondayAdapter.ViewHolder>{
    ...
    public WeeklyMondayAdapter(Context context, String[] activityNameList, String[] activityLocationList, String[] activityTimeList){
    ...
    @NonNull
    @Override
    public umn.ac.keadaanudara.WeeklyMondayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull umn.ac.keadaanudara.WeeklyMondayAdapter.ViewHolder holder, int position) {
