...
public class WeeklyThursdayAdapter extends RecyclerView.Adapter<umn.ac.keadaanudara.WeeklyThursdayAdapter.ViewHolder>{
    ...
    public WeeklyThursdayAdapter(Context context, String[] activityNameList, String[] activityLocationList, String[] activityTimeList){
    ...
    @NonNull
    @Override
    public umn.ac.keadaanudara.WeeklyThursdayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull umn.ac.keadaanudara.WeeklyThursdayAdapter.ViewHolder holder, int position) {
